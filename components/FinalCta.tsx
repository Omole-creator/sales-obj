  ...
  return (
    <section className="relative overflow-hidden bg-orange-600 px-5 py-20 text-black sm:px-8">
      <div className="relative mx-auto max-w-3xl text-center">
        <div className="mx-auto flex w-fit items-center gap-2 rounded-full bg-black px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-brand">
        ...
        <p className="mx-auto mt-5 max-w-xl text-lg font-medium text-black/80">
        ...
        <ul className="mt-7 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm font-semibold text-black/70">
      ...
      <div className="relative mx-auto mt-20 max-w-3xl">
        <h3 className="text-center font-display text-2xl uppercase text-black sm:text-3xl">
      ...
      <div className="relative mx-auto mt-16 max-w-3xl rounded-2xl border-2 border-black bg-black p-7 text-left sm:p-9">
        <p className="leading-relaxed text-white/85">
          <span className="font-display text-xl uppercase text-brand">P.S.</span> Every day
          you wait, another &ldquo;I&rsquo;ll get back to you&rdquo; quietly walks out of
